...
/**
 * @file
 * SHTI_BP functions implementation.
 ...
 */
int st_shti_bp_simulate_suffix_link_bottom_up (signed_integral_type *parent,
 ...
 */
int st_shti_bp_mccreight_insert_suffix (signed_integral_type *parent,
 ...
 * 		If an error occurs, a positive error number is returned.
 */
int st_shti_bp_ukkonen_prolong_suffix (size_t starting_position,
 ...
 * 		If an error occurs, a nonzero error number is returned.
 */
int st_shti_bp_ukkonen_prolong_suffixes (size_t *starting_position,
		size_t ending_position,
		size_t *active_index,
 ...
 * 		If an error occurs, a nonzero error number is returned.
 */
int st_shti_bp_create_mccreight (const character_type *text,
		size_t length,
		suffix_tree_shti_bp *stree) {
 ...
 * 		If an error occurs, a nonzero error number is returned.
 */
int st_shti_bp_create_ukkonen (const character_type *text,
		size_t length,
		suffix_tree_shti_bp *stree) {
