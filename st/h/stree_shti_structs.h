 ...
 */
#ifndef	SUFFIX_TREE_SHTI_STRUCTS_HEADER
#define	SUFFIX_TREE_SHTI_STRUCTS_HEADER
 ...
 * in the implementation type SHTI.
 */
 ...
 * in the implementation type SHTI.
 */
typedef struct suffix_tree_shti_struct {
	/** hash settings size */
	size_t hs_size;
	/** edge record size */
	size_t er_size;
...
#endif /* SUFFIX_TREE_SHTI_STRUCTS_HEADER */
