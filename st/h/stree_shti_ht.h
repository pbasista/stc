 ...
 */
#ifndef	SUFFIX_TREE_SHTI_HASH_TABLE_HEADER
#define	SUFFIX_TREE_SHTI_HASH_TABLE_HEADER

#include "stree_shti_structs.h"
...
#endif /* SUFFIX_TREE_SHTI_HASH_TABLE_HEADER */
